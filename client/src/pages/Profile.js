				...
				<div className="max-w-3/4 w-full mt-16">
					...
					<div>
						...
						{!profileEditStatus?<div className="px-4 mt-2 flex justify-center py-3 bg-gray-50 text-right sm:px-6">
							 <button
								type="submit"
								className="inline-flex justify-center w-1/2 block py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-400 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
