							...
							<div className="bg-green-100 border-t-4 border-green-500 rounded-b text-green-900 px-4 py-3 shadow-md mb-2" role="alert">
								<div className="flex">
									...
									<div>
										...
										<p className="text-sm">Make Sure To Follow Others From <Link to="/connections" class="text-green-500 font-bold italic hover:underline hover:text-green-700">Connection Page</Link></p>
									</div>
								</div>
							</div> : ''
						}
