...
const MovieShowCard = ({ show, fromSearch, fromStatus }) => {
	...
	if (fromStatus) {
		posterClassName = "w-1/6 xs:w-1/3 lg:rounded-r max-w-screen max-h-screen object-cover";
		overViewDivClassName = "pl-2 w-5/6 xs:w-2/3";
	} else {
		posterClassName = "w-full lg:w-1/3 lg:rounded-r max-w-screen max-h-screen object-cover";
