          ...
          <div className="max-w-full fixed bg-white max-h-24 h-24 inset-x-0 top-0 mx-auto px-4 sm:px-6 z-10">
            <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
              ...
              <div className="flex space-x-4 justify-start lg:w-0 lg:flex-1 items-center">
                <Link to="/feed">
                  ...
                  <span className="has-tooltip">
                    <span className="tooltip rounded shadow-lg p-2 bg-white-100 text-xs mt-8 -ml-4">
                      ScreenView
                    </span>
              ...
              <div className="hidden lg:max-w-1/10 md:flex items-center justify-center md:flex-1 lg:w-0">
                <Link
                  to="/feed"
                  className="ml-8 has-tooltip bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                >
                  <span className="tooltip rounded shadow-lg p-2 bg-white-100 text-xs mt-20">
                    Home
                  </span>
                ...
                <Link
                  to="/watchlist"
                  className="ml-8 has-tooltip has-tooltip bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                >
                  <span className="tooltip rounded shadow-lg p-2 bg-white-100 text-xs mt-20">
                    Watch List
                  </span>
              ...
              <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50 z-40">
                ...
                <div className="py-6 px-5 space-y-6">
                  <div className="grid grid-cols-2 gap-y-4 gap-x-8 flex justify-between">
                    ...
                    <button
                      className="ml-8 bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                      onClick={() =>
                        logout({
