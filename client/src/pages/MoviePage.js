            ...
            <div className="max-w-1/2 items-center text-center">
              <div className="flex mt-1 justify-center p-5 max-w-1/2">
                ...
                <div className="pl-3 w-full lg:w-4/5">
                  ...
                  <h5 className="text-xs text-left mb-4">
                  ...
                  <p className="h-auto text-left text-sm">
                    {movieDetails.overview}
                  </p>

                  <div className="flex text-xs mt-3">
                    <p className="text-xs underline">Genres:</p>
                    {movieDetails.genres.map((genre) => (
                      <p className="text-xs ml-4 no-underline" key={genre.id}>
                        {genre.name};
                      </p>
                    ))}
                  </div>
                  ...
                  >
                    <p className="mt-2 text-indigo-400 hover:text-blue-800 hover:underline">
                      HomePage
                    </p>
                  </a>
                </div>
            ...
            {visibleReviews ? (
              <div className="w-full mt-4">
                {visibleReviews.map((review) => (
                  <div
                    key={review.id}
                    className="bg-white border-1 bg-gray-100 border-white mb-2 rounded-lg shadow content-center p-2 text-md text-gray-700"
                  >
                    <div>
                      <div className="flex items-center justify-start">
                        <img
                          ...
                          alt=""
                        />
                        <h4 className="text-blue-400 text-weight-600">
                          @{review.author.name}
                        </h4>
                      </div>
